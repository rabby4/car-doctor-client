        ...
        <div className="hero py-32">
            <div className="hero-content flex-col lg:flex-row">
                <div className='w-1/2 relative'>
                    ...
                    <img src={parts} className="w-1/2 rounded-lg absolute right-5 top-1/2 border-8 border-white" />
                </div>
                <div className='w-1/2'>
                    ...
                    <button className="btn bg-orange-600 hover:bg-orange-500 text-white mt-5">Get Started</button>
                </div>
            </div>
        </div>
    );
